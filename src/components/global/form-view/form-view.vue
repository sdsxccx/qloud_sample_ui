/* * @Author: liguanghui * @Date: 2020-07-24 14:55:01 * @Last Modified by:
liguanghui * @Last Modified time: 2020-07-29 09:30:46 */
<template>
  <div
    class="m-form"
  ...
  >
    ...
    >
      <div
        class="form-item-collapse"
        v-if="(isHandle && isBlock) || isCollapse"
      >
        <collapse>
          ...
          >
            ...
            <!-- collapse 数字输入框 add by Liuhan 2020-11-04-->
      ...
      <!-- 操作 -->
      <el-form-item
        v-if="isHandle && isLeft && !isBlock && !isCollapse"
        :class="isLeft ? 'left' : ''"
        label-width="0"
      >
        <el-button
      ...
      <!-- 操作 -->
      <el-form-item
        v-if="isHandle && !isBlock && !isLeft && !isCollapse"
        label-width="0"
      >
        <el-button
          :loading="item.loading"
